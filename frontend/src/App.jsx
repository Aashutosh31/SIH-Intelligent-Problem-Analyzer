        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-lg">
            ...
            <p className="text-sm text-slate-400 mb-4">
              ...
              We'll extract the engineering reality.
            </p>
          ...
          {!analysis && !isAnalyzing && !error && (
            <div className="bg-slate-900/50 border border-slate-800 border-dashed rounded-xl p-6 text-center text-slate-500">
              ...
              />
              <p className="text-sm">
                Enter a problem statement to generate architecture,
                risk analysis, and team fit scores.
              </p>
            </div>
          )}
        </div>
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-b-xl rounded-tr-xl p-6 min-h-[400px]">
                ...
                {activeTab === "ai" && (
                  <AiVibeTab
                    ...
                    aiVibePotential={
                      analysis.scorecard.aiVibePotential
                    }
                  />
                )}
