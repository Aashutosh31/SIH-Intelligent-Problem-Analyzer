    ...
    <div className="space-y-6">
      ...
      {teamFit && (
        <div className="border-t border-white/10 pt-6">
          ...
          <div className="rounded-xl border border-white/10 bg-black/60 p-4 mb-5">
          ...
          {partialMatches.length > 0 && (
            <div className="mt-5 rounded-2xl border border-amber-900/50 bg-amber-950/10 p-4">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h4 className="text-sm font-semibold text-white">
              ...
              <div className="flex flex-wrap gap-2">
                {missingSkills
                  ...
                  .map((skill) => (
                    <div
                      key={skill.skill}
                      className="inline-flex items-center gap-2 rounded-lg border border-white/15 bg-white/[0.03] px-3 py-2"
                    >
