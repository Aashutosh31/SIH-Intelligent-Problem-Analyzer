...
const TeamCoverageMatrix = ({ teamFit }) => {
  ...
  return (
    <div className="mt-6 rounded-2xl border border-white/10 bg-black/50 overflow-hidden">
      {/* Header */}
                ...
                >
                  ...
                  <td className="px-4 py-4 align-top">
                    <div className="space-y-2">
                      <span
                        className={`inline-flex items-center gap-1.5 rounded-lg border px-2 py-1 text-[10px] font-medium ${status.className}`}
                      >
                        <StatusIcon size={12} />
                        {status.label}
                      </span>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <span
                  className={`inline-flex items-center gap-1 rounded-lg border px-2 py-1 text-[10px] font-medium shrink-0 ${status.className}`}
                >
                  <StatusIcon size={11} />
                  {status.label}
                </span>
