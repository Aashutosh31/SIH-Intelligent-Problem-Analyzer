...
const SkillGapPanel = ({ skillGapRecommendations }) => {
  ...
  if (totalGaps === 0) {
    return (
      <div className="mt-8 rounded-2xl border border-emerald-900/50 bg-emerald-950/10 p-5">
    ...
    <div className="mt-8 space-y-5">
      ...
      <div>
        <div className="flex items-center gap-2.5">
          <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-blue-500/10 border border-blue-500/20 shrink-0">
            <BrainCircuit
              size={14}
        ...
        <div className="space-y-4">
          {recommendations.map((recommendation, index) => (
            <div
              ...
              className="rounded-2xl border border-white/10 bg-black/50 overflow-hidden"
            >
              {/* Requirement header */}
              <div className="px-4 py-4 border-b border-white/10">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <span
                    className={`inline-flex items-center rounded-lg border px-2 py-1 text-[10px] font-semibold shrink-0 ${getPriorityClasses(
