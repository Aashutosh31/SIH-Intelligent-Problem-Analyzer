                ...
                {member.assignments.map((assignment, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <span
                        className={`shrink-0 inline-flex items-center rounded-lg border px-2 py-1 text-[10px] font-semibold ${
            ...
            {unassignedRequirements
              ...
              .map((requirement, index) => (
                <div
                  ...
                  className="flex items-center justify-between gap-4 rounded-xl border border-white/10 bg-black p-3"
                >
